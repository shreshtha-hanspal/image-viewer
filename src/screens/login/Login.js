            ...
            <PageHeader title="Image Viewer">
                <Card className="login-card">
                    <CardContent>
                        ...
                        <FormHelperText error className={this.state.incorrectLoginInfoText}>Incorrect username and/or
                            password</FormHelperText>
                    </CardContent>
                    <CardActions>
                        <FormControl margin="normal" size="medium" variant="standard">
                            <Button variant="contained" color="primary" id="btn-login"
                                    onClick={this.loginUserOnBtnClick}>LOGIN</Button>
                        </FormControl>
                    </CardActions>
                </Card>
            </PageHeader>
