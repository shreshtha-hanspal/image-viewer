                ...
                <header className="app-header">
                    ...
                    {this.props.loggedIn === "true" ?
                        <div className="after-login">
                            ...
                            <Menu className="simple-menu" elevation={0} getContentAnchorEl={null}
                                  anchorEl={this.state.anchorEl} anchorOrigin={{
                                vertical: 'bottom',
                                horizontal: 'center',
                            }} transformOrigin={{
                                vertical: 'top',
                                horizontal: 'center',
                            }} keepMounted open={Boolean(this.state.anchorEl)} onClose={this.handleClose}>
                                <div className={classes.bg}>
                                    {this.props.showSearchTab === "true" ?
                                        <div>
                                            <MenuItem onClose={this.handleClose} onClick={this.profilePageHandler}>
